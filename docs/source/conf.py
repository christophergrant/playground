...
release = minor_major(playground.__version__)
...
html_theme_options = {
    ...
    'github_url': 'https://github.com/christophergrant/playground',
    'repository_url': 'https://github.com/christophergrant/delta-playground',
